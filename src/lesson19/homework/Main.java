...
public class Main {
    public static void main(String[] args) throws CustomException {
        ...
        System.out.println("\nВыведем результат деления двух чисел number1 и number2:");
        System.out.println(stringUtils.div("24", "3"));

        System.out.println("\nВыведем массив количества вхождений слова в текст:");
        ...
        System.out.println("\nВыведем массив чисел из текста:");
